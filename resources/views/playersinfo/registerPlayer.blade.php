            ...
            <div class="col-6">
                ...
                <div class="container">
                    ...
                    <form id="contact" action="{{route('registerplayer')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            <input placeholder="Jersey number" min=1 type="number" name="jerseyNumber" tabindex="8"
                                required>
                        </fieldset>
                        <fieldset>
                        ...
                        <fieldset>
                            <textarea placeholder="History" type="text" name="playerHistory" tabindex="11"
                                required></textarea>
                        </fieldset>
                        <fieldset>
                        ...
                        <fieldset>
                            <button name="submit" type="submit" id="contact-submit" data-submit="...Sending" @if
                                ((count($selection)==0) || (count($clubs)==0)) disabled @endif>Submit</button>
                        </fieldset>
                        <p class="copyright">Designed by <a href="#" target="_blank" title="Colorlib">tim_kornjača</a>
                        </p>
                    </form>
                </div>
                <div clas="col-3"></div>
