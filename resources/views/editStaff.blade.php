...
<div class="col-6">
<br><br>
<button type="button" class="btn btn-secondary btn-lg btn-block"><a href="/staff">Back</a></button>
 
  <form id="contact" action="{{route('updatestaff', $staff->id)}}" method="POST">
  {{csrf_field()}}
    <h3>Update Staff</h3>
    <fieldset>
    ...
    <fieldset>
    Description:<br><input placeholder="Description" type="text" name ="description" value="{{$staff->description}}" tabindex="2" >
    </fieldset>
