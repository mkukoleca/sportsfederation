          ...
          <fieldset>
            <span>Referee1</span>
                    <select name="referee1Id">
                      ...
                      <option value="{{$staff->id}}" @if ($staff->id == $game->referee1Id) selected @endif>{{$staff->name}}</option>
                      @endforeach
                    </select>
          </fieldset>
          <fieldset>
          ...
          <fieldset>
            <span>Delegate</span>
                      <select name="delegateId">
                        @foreach ($staffs as $staff)
                        <option value="{{$staff->id}}" @if ($staff->id == $game->delegateId) selected @endif>{{$staff->name}}</option>
                        @endforeach
                      </select>
          </fieldset> 
          <fieldset>
