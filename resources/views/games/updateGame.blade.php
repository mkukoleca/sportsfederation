            ...
            <div class="col-6">
                <div class="container">
                    ...
                    <form id="contact" action="{{route('updategame', $game->id)}}" method="POST">
                        ...
                        <fieldset>
                            Date:<br><input placeholder=" Date" type="date" name=" date" value="{{$game-> date}}"
                                tabindex="2">
                        </fieldset>
                        <fieldset>
                            Place:<br><input placeholder="Place" type="text" name="place" value="{{$game->place}}"
                                tabindex="3">
                        </fieldset>
                        <fieldset>
                            <span>Home</span>
                        ...
                        <fieldset>
                            Round:<br><input placeholder=" Round" type="number" min="1" name=" round"
                        ...
                        <fieldset>
                            Note:<br><textarea placeholder="Note" type="text" name="note" min="1"
                                value="{{$game->note}}" tabindex="12"></textarea>
                        </fieldset>
                        <fieldset>
